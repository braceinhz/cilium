...
func (k *K8sWatcher) updateK8sPodV1(oldK8sPod, newK8sPod *slim_corev1.Pod) error {
	...
	annotationsChanged := !k8s.AnnotationsEqual([]string{annotation.ProxyVisibility,
		bandwidth.EgressBandwidth}, oldAnno, newAnno)
	...
	if annotationsChanged {
		if !k8s.AnnotationsEqual([]string{annotation.ProxyVisibility}, oldAnno, newAnno) {
		...
		if !k8s.AnnotationsEqual([]string{bandwidth.EgressBandwidth}, oldAnno, newAnno) {
